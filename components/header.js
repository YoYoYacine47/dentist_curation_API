...
function Header() {
  return (
    <div>
      <nav className="bg-white border-gray-200 px-5 sm:px-4 py-2.5 rounded dark:bg-gray-800 mb-10">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <a href="#" className="flex items-center">
            <div className="relative mr-3 w-6 h-6 sm:h-9">
              <Image
                layout="fill"
                objectFit="contain"
                src="/favicon.ico"
